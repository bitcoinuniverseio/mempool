...
const dest=resolve(root,'../../frontend/src/resources/liquid-proof');
mkdirSync(dest,{recursive:true});
copyFileSync(resolve(root,'target/wasm32-unknown-unknown/release/universe_liquid_proof.wasm'),resolve(dest,'universe_liquid_proof.wasm'));
