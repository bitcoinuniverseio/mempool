...
env.RUSTFLAGS = '-C link-arg=--max-memory=134217728';
...
const dest=resolve(root,'../../frontend/src/resources/zcash-scanner');
mkdirSync(dest,{recursive:true});
copyFileSync(resolve(root,'target/wasm32-unknown-unknown/release/universe_zcash_scanner.wasm'),resolve(dest,'universe_zcash_scanner.wasm'));
