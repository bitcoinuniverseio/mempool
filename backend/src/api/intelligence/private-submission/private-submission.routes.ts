  ...
  public initRoutes(app: Application): void {
    ...
    app.post(
      ...
      (req: Request, res: Response) => {
        try {
          res.json(
            privateSubmissionService.submitPrivate(submissionInput(req.body))
          );
        } catch (err) {
          fail(res, err);
        }
    ...
    app.get(
      ...
      (req: Request, res: Response) => {
        try {
          res.json(
            privateSubmissionService.getPrivateSubmission(
    ...
    app.post(
      ...
      (req: Request, res: Response) => {
        try {
          res.json(
            privateSubmissionService.abortPrivateSubmission(
              tokenInput(req.params.submissionToken)
            )
          );
        } catch (err) {
