...
export const fixtures = {
  ...
  '/api/v1/universe/sources': {
    generatedAt: '2026-09-06T05:30:00Z',
    sources: [
      {
        ...
        checkpoint: {
          ...
          observedAt: '2026-09-06T05:28:00Z',
        },
        checkedAt: '2026-09-06T05:29:00Z',
        lagBlocks: '0',
        lastSuccessAt: '2026-09-06T05:29:00Z',
      ...
      },
      {
        ...
        checkpoint: {
          ...
          network: 'mainnet',
          heightAtomic: '907144',
          blockHash: '000000000000000000012a4c5d8e9f0a1b2c3d4e5f60718293a4b5c6d7e8f90a1b',
          observedAt: '2026-09-06T05:28:00Z',
        },
        checkedAt: '2026-09-06T05:29:00Z',
        lagBlocks: '0',
...
export const stateOverrides = {
  ...
  'authority-down': {
    ...
    '/api/v1/universe/sources': { status: 502 },
