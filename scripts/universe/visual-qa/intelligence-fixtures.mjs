...
export const intelligenceFixtures = {
  ...
  'GET /api/v1/intelligence/dlc/overview': {
    ...
    healthy_oracles: 5,
    active_events: 142,
    total_attestations: 128,
    verified_conflicts: 0,
    recent_events: [
      { event_id: 'evt-btc-usd-20260901', oracle_id: 'kormir-secp256k1-01', event_descriptor: { type: 'numeric' }, event_maturity_epoch: 1788220800, maturity_formatted: '2026-09-01', verified: false },
    ],
    recent_attestations: [],
    active_conflicts: [],
  },
  ...
  'GET /api/v1/intelligence/offchain/operators/statechain-mercury-alpha': {
    ...
    endpoints: { clearnet: 'https://statechain.example.com' },
    health: 'degraded',
    networks: ['bitcoin-mainnet'],
    operator_public_key: '03abc123def456',
    supported_versions: ['v2.1'],
    transfer_capabilities: [],
    recovery_capabilities: [],
    effective_from: '2026-09-01T00:00:00Z',
    expires_at: '2026-10-01T00:00:00Z',
    provenance: { registered_in_knowledge_registry: false, verified_signature: false },
  },
  'GET /api/v1/intelligence/offchain/operators/sc-mercury-alpha': {
    ...
    endpoints: { clearnet: 'https://alpha.mercury.example.com' },
    ...
    supported_implementations: [
      {
        ...
        dialect_features: { native_extensions_supported: ['arkade_round_batch', 'vtxo_merkle_proof'], fee_anchor_type: 'ephemeral_anchor_v3', taproot_tree_style: 'standard_bip341_taptree' },
      },
      {
        ...
        dialect_features: { native_extensions_supported: ['bark_checkpoint', 'covenant_tree'], fee_anchor_type: 'cpfp_anchor_output', taproot_tree_style: 'script_path_multisig' },
      },
    ],
  ...
  'GET /api/v1/intelligence/submission/capabilities': {
  ...
  'POST /api/v1/intelligence/submission/private': {
    ...
    network: 'mainnet',
    status: 'queued',
    queued_at_utc: '2026-09-04T15:20:00Z',
    retry_count: 0,
    last_error: null,
    can_abort: true,
  },
