...
__MEMPOOL_HTTP_HOST__=${MEMPOOL_HTTP_HOST:=0.0.0.0}
...
__MEMPOOL_MINING_MAX_BEHIND_TIP__=${MEMPOOL_MINING_MAX_BEHIND_TIP:=3}
...
sed -i "s!__MEMPOOL_HTTP_HOST__!${__MEMPOOL_HTTP_HOST__}!g" mempool-config.json
...
sed -i "s!__MEMPOOL_POOLS_JSON_FILE__!${__MEMPOOL_POOLS_JSON_FILE__}!g" mempool-config.json
