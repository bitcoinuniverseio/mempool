...
import type { AddressType } from './address-utils';
...
export function convertScriptSigAsm(hex: string): string {
...
export function isInternalKeyNUMS(internalKey: string): boolean {
