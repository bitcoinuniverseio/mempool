    ...
    <div class="intelligence-page container-xl">
      <header class="page-header mb-4">
        ...
        <nav class="nav nav-pills flex-wrap gap-2 pt-2 border-top border-secondary-subtle">
          ...
          <a class="nav-link active" [routerLink]="'/intelligence/quantum/history' | relativeUrl">Reveal Timeline</a>
      ...
      <div *ngIf="!loading && events.length > 0" class="card bg-body-tertiary border">
        <div class="table-responsive" tabindex="0" role="region" aria-label="Public Key Reveal Timeline, scroll horizontally" i18n-aria-label>
