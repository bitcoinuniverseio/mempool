  ...
  template: `
    <div class="intelligence-page container-xl">
      ...
      <section class="card mb-4" *ngIf="cohorts?.script_types">
        ...
        <div class="table-responsive" tabindex="0" role="region" aria-label="Supply Distribution by Script Type, scroll horizontally" i18n-aria-label>
      ...
      <section class="card mb-4" *ngIf="thresholds.length > 0">
        ...
        <div class="table-responsive" tabindex="0" role="region" aria-label="Economically Unspendable Outputs Across Feerates, scroll horizontally" i18n-aria-label>
          <table class="table table-hover mb-0">
            <thead>
              <tr>
