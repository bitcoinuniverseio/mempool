  ...
  template: `
    <div class="container-xl py-4">
      ...
      <div class="card bg-dark border-secondary mb-4" *ngIf="overview">
        ...
        <div class="table-responsive" tabindex="0" role="region" aria-label="Consensus Engine Conformance Ratings, scroll horizontally" i18n-aria-label>
      ...
      <div class="card bg-dark border-secondary mb-4" *ngIf="overview">
        ...
        <div class="table-responsive" tabindex="0" role="region" aria-label="Active Discrepancy Findings, scroll horizontally" i18n-aria-label>
          <table class="table table-dark table-hover mb-0">
            <thead>
              <tr>
                <th>Case ID</th>
