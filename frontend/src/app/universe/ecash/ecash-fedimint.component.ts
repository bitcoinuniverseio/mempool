    ...
    <div class="intelligence-page container-xl">
      <header class="page-header mb-4">
        ...
        <nav class="nav nav-pills flex-wrap gap-2 pt-2 border-top border-secondary-subtle">
          ...
          <a class="nav-link active" [routerLink]="'/ecash/fedimint' | relativeUrl">Fedimint Federations</a>
        ...
        <div *ngFor="let fed of federations" class="col-12 col-lg-6">
          <div class="card p-4 h-100 bg-body-tertiary border">
            ...
            <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
              ...
              <a [routerLink]="['/ecash/fedimint' | relativeUrl, fed.federation_id]" class="btn btn-sm btn-outline-primary">
                Inspect Federation
              </a>
            </div>
          </div>
