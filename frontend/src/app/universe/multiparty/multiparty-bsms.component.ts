    ...
    <div class="intelligence-page container-xl">
      <header class="page-header mb-4">
        ...
        <nav class="nav nav-pills flex-wrap gap-2 pt-2 border-top border-secondary-subtle">
          ...
          <a class="nav-link active" [routerLink]="'/tools/multiparty/bsms' | relativeUrl">BSMS Setup (BIP129)</a>
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-lg-6">
          <div class="card p-4 bg-body-tertiary border h-100">
            ...
            <pre class="p-3 bg-body border rounded font-monospace small text-break mb-3" tabindex="0" role="region" aria-label="Sample BSMS Descriptor Template, scroll horizontally" i18n-aria-label>
wsh(sortedmulti(2,
