...
describe('Bitcoin staking pages when the indexer is absent', () => {
  it('does not invent a synchronized reconciliation when the consumer chain is absent', () => {
    const api = { networkChanges$: of('signet'), reconcile$: unavailable('unavailable-consumer-chain') } as unknown as BitcoinStakingApiService;
  ...
  it('surfaces an absent evidence source instead of an empty evidence list', () => {
    const api = { networkChanges$: of('signet'), getEvidence$: unavailable('unavailable-staking-indexer') } as unknown as BitcoinStakingApiService;
  ...
  it('shows the overview error state rather than an empty overview', () => {
    const api = { networkChanges$: of('signet'), getOverview$: unavailable('unavailable-staking-indexer') } as unknown as BitcoinStakingApiService;
