...
/*
 * Outstanding: WP05 of the Dogecoin mainnet readiness plan. The browser
 * journeys behind these readings are not yet exercised against a live
 * candidate API; the plan and its acceptance rows live in the handoff
 * bundle, not in this file.
 */
