    ...
    <div class="intelligence-page container-xl">
      <header class="page-header mb-4">
        ...
        <nav class="nav nav-pills flex-wrap gap-2 pt-2 border-top border-secondary-subtle">
          <a class="nav-link active" [routerLink]="'/payments' | relativeUrl">Overview</a>
      ...
      <div *ngIf="!loading && overview" class="row g-4">
        ...
        <div class="col-12 col-lg-8">
          <div class="card p-4 bg-body-tertiary border h-100">
            ...
            <div class="table-responsive" tabindex="0" role="region" aria-label="Verified Client &amp; Wallet Applications, scroll horizontally" i18n-aria-label>
        ...
        <div class="col-12 col-lg-4">
          <div class="card p-4 bg-body-tertiary border h-100">
            ...
            <div class="mt-3">
              <a [routerLink]="'/payments/nwc/inspect' | relativeUrl" class="btn btn-outline-primary btn-sm w-100">
