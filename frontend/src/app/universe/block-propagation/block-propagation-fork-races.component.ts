  ...
  template: `
    <div class="container-xl py-4">
      ...
      <div class="card bg-dark border-secondary mb-4">
        ...
        <div class="table-responsive" tabindex="0" role="region" aria-label="Detected Simultaneous Block Races, scroll horizontally" i18n-aria-label>
          <table class="table table-dark table-hover mb-0">
            ...
            <tbody>
              <tr *ngFor="let r of forkRaces">
                ...
                <td>
                  <a [routerLink]="['/network/fork-races' | relativeUrl, r.race_id]" class="btn btn-outline-info btn-sm">Inspect Race</a>
                </td>
              </tr>
            </tbody>
          </table>
...
export class BlockPropagationForkRacesComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.api.getForkRaces$().subscribe({
      next: res => {
        this.forkRaces = res;
        this.loadError = null;
      },
