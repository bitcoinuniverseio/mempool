      ...
      <div *ngIf="overview" class="alert alert-secondary mt-3"><p *ngFor="let note of overview.notes" class="mb-1">{{ note }}</p></div><div *ngIf="!loading && overview" class="row g-4">
        ...
        <div class="col-12" *ngIf="overview.recent_observations?.length">
          <div class="card bg-body-tertiary border p-3">
            ...
            <div class="table-responsive" tabindex="0" role="region" aria-label="Historical public lockup checks, scroll horizontally" i18n-aria-label><table class="table table-hover small">
        ...
        <div class="col-12">
          <div class="card bg-body-tertiary border p-3">
            ...
            <div class="table-responsive" tabindex="0" role="region" aria-label="Recent Verified Swap Records, scroll horizontally" i18n-aria-label>
